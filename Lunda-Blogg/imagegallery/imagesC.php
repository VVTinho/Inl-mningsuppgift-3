...
<body>
	<div id="container"> <!-- Skapar en container. -->
		...
		<div id="page-links"> <!--  Skapar page-links. --> 
			<a href="../imagegallery/imagesA.php">Bilder-A &nbsp;</a> <!-- Skapar en länk till kultursidan.php. -->
			<a href="../imagegallery/imagesB.php">Bilder-B</a> <!-- Skapar en länk till cykelsidan.php. -->
